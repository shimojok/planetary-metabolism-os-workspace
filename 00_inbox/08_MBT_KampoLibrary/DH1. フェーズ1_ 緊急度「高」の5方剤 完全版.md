方法A: 段階的構築で、完全版JSONを作成してください。

---

承知しました。方法A（段階的構築）で、優先度順に完全版JSONを作成します。

## フェーズ1: 緊急度「高」の5方剤 完全版
