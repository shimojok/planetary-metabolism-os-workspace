    ...
    "formulas": {
      "F143": {
        ...
        "formula_synergy": {
          ...
          "synergy_mechanism": "細辛の鎮痛作用＋升麻・甘草の抗炎症作用で歯痛・口内炎を迅速に改善",
          "enhancement_factor": 2.4,
          "key_minerals": ["Ca", "Mg", "Zn"]
        },
        "indications": {
          "primary": ["歯痛", "口内炎", "歯肉炎", "咽頭痛"],
          "secondary": ["頭痛", "神経痛"],
        ...
        "mbt55_optimization": {
          ...
          "enhanced_compounds": ["オイゲノール", "グリチルレチン酸", "シミセノシドA"],
      ...
      "F146": {
        ...
        "name": "苓甘姜味辛夏仁湯",
        "category": "咳嗽・喘息",
        "main_herbs": ["茯苓", "甘草", "乾姜", "五味子", "細辛", "半夏", "杏仁"],
        "components": {
          "茯苓": {
            "polysaccharides": {
              "type": "β-グルカン",
        ...
        "formula_synergy": {
          ...
          "synergy_mechanism": "五味子・細辛の鎮咳作用＋乾姜・半夏の去痰作用で咳嗽・喘息を改善",
          "enhancement_factor": 2.4,
        ...
        "mbt55_optimization": {
          ...
          "fermentation_time": "24時間",
          "enhanced_compounds": ["シサンドリン", "6-ショウガオール", "グリチルレチン酸", "短鎖脂肪酸"],
          "bioavailability_boost": "2-5倍"
        }
      },
      "F147": {
...
**フェーズ37完了**: 5方剤（F143, F145, F146, F147, F148）を追加
**累計**: 171 + 5 = **176方剤**

次は**フェーズ38（F149, F150, F152, F153, F154）**を作成しますか？