  ...
  "mbt_kampo_library": {
    ...
    "formulas": {
      "F161": {
        ...
        "name": "藿香正気散",
        "category": "胃腸炎・夏バテ",
        "main_herbs": ["藿香", "蒼朮", "陳皮", "厚朴", "白芷", "茯苓", "大腹皮", "半夏", "甘草", "生姜", "大棗"],
        "components": {
          "藿香": {
            "phytochemicals": [
              {
        ...
        "formula_synergy": {
          ...
          "synergy_mechanism": "藿香・蒼朮の消化促進作用＋厚朴・大腹皮の消化管運動促進作用で胃腸炎・夏バテを改善",
          "enhancement_factor": 2.4,
          "key_minerals": ["K", "Mg", "Ca"]
        },
        "indications": {
          "primary": ["胃腸炎", "夏バテ", "消化不良", "吐き気"],
          "secondary": ["下痢", "腹部膨満", "感冒"],
          "contraindications": ["実証", "急性感染症"]
        },
        "mbt55_optimization": {
          "recommended_strains": ["MBT55-003", "MBT55-004", "MBT55-005"],
          "fermentation_time": "24時間",
          "enhanced_compounds": ["パチョリアルコール", "アトラクチロジン", "リモネン", "短鎖脂肪酸"],
      ...
      "F162": {
        ...
        "name": "荊芥連翹湯",
        "category": "鼻炎・蓄膿症",
        "main_herbs": ["荊芥", "連翹", "防風", "薄荷", "桔梗", "甘草", "川芎", "当帰", "芍薬", "地黄", "柴胡", "黄芩", "山梔子"],
        "components": {
          "荊芥": {
            "phytochemicals": [
              {
        ...
        "formula_synergy": {
          ...
          "synergy_mechanism": "荊芥・連翹の抗炎症作用＋桔梗の排膿作用＋川芎・当帰の血流改善で鼻炎・蓄膿症を改善",
          "enhancement_factor": 2.4,
          "key_minerals": ["Fe", "Zn", "Mg", "Ca"]
        },
        "indications": {
          "primary": ["鼻炎", "蓄膿症", "副鼻腔炎", "扁桃炎"],
          "secondary": ["頭痛", "鼻閉", "嗅覚障害"],
          "contraindications": ["胃腸虚弱", "冷え症"]
        },
        "mbt55_optimization": {
          "recommended_strains": ["MBT55-001", "MBT55-003", "MBT55-004"],
          "fermentation_time": "24時間",
          "enhanced_compounds": ["フォルシトサイド", "プラチコジン", "バイカレイン", "テトラメチルピラジン"],
          "bioavailability_boost": "2-5倍"
        }
      },
      "F163": {
        ...
        "formula_synergy": {
          ...
          "synergy_mechanism": "桂枝湯の基本作用に黄耆を加え、冷えを伴う多汗症を改善",
          "enhancement_factor": 2.2,
          "key_minerals": ["Zn", "Mg", "Ca"]
        },
        "indications": {
          "primary": ["冷え症", "多汗症", "寝汗", "虚弱体質"],
          "secondary": ["感冒予防", "疲労"],
        ...
        "mbt55_optimization": {
          ...
          "fermentation_time": "24時間",
          "enhanced_compounds": ["桂皮酸", "シクロアストラゲノール", "短鎖脂肪酸"],
      ...
      "F164": {
        ...
        "formula_synergy": {
          "primary_pathway": "PATH_01",
          "secondary_pathways": ["PATH_04", "PATH_05"],
          "synergy_mechanism": "桂枝湯の芍薬を増量し、腹痛・下痢を改善",
        ...
        "mbt55_optimization": {
          "recommended_strains": ["MBT55-001", "MBT55-004"],
          "fermentation_time": "24時間",
          "enhanced_compounds": ["パエオニフロリゲニン", "桂皮酸", "短鎖脂肪酸"],
          "bioavailability_boost": "2-4倍"
        }
      },
      "F165": {
        ...
        "formula_synergy": {
          ...
          "synergy_mechanism": "桂枝加芍薬湯に竜骨・牡蛎の鎮静作用を加え、不安・不眠を改善",
        ...
        "mbt55_optimization": {
          ...
          "enhanced_compounds": ["イオン化カルシウム", "イオン化マグネシウム", "桂皮酸"],
          "bioavailability_boost": "2-5倍"
        }
      }
    }
...
**フェーズ40完了**: 5方剤（F161, F162, F163, F164, F165）を追加
**累計**: 186 + 5 = **191方剤**

次は**フェーズ41（F166, F167, F168, F169, F170）**を作成しますか？